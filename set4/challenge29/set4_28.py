...
def SHA_1(message:bytes,h0 = 0x67452301,h1 = 0xEFCDAB89,h2 = 0x98BADCFE,h3 = 0x10325476,h4 = 0xC3D2E1F0,forged_msg_len=None):

    #initilize the variables 
    
    MAX_WORD = 0xFFFFFFFF
    
    if forged_msg_len == None:
        padded_msg = sha1_padding(message)
    else:
        #forged_msg_len = len(message) + forged_msg_len
        padded_msg = sha1_padding(message,forged_msg_len)
